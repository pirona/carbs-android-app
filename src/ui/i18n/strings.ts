...
export const STRINGS = {
  ...
  'settings.accent.lemon': { fr: 'Citron', en: 'Lemon' },
  ...
  'settings.ai.title': { fr: '🤖 IA (Mistral)', en: '🤖 AI (Mistral)' },
  ...
  'settings.footprint.methodology': {
    fr: "Estimation approximative basée sur l'étude d'impact environnemental de Mistral Large 2 (Mistral AI, ADEME, Carbone 4, juillet 2025 : ~1,14 gCO2e et 45 mL d'eau pour une réponse de 400 tokens). Ce facteur par token est appliqué uniformément à tous les modèles utilisés par l'app (mistral-small-latest et mistral-large-latest) faute de détail officiel par taille de modèle — l'étude indique seulement que l'impact est globalement proportionnel à la taille du modèle, donc l'empreinte réelle des appels \"small\" est probablement surestimée ici.",
    en: 'Approximate estimate based on Mistral Large 2\'s environmental impact study (Mistral AI, ADEME, Carbone 4, July 2025: ~1.14 gCO2e and 45 mL of water for a 400-token response). This per-token factor is applied uniformly to every model this app uses (mistral-small-latest and mistral-large-latest) for lack of an official breakdown by model size — the study only states that impact is roughly proportional to model size, so the real footprint of "small" calls is probably overestimated here.',
  },
  ...
  'settings.about.aiDisclaimer': { fr: "IA : uniquement Mistral (aucun autre fournisseur). Le scan photo d'assiette peut se tromper sur ce qu'il identifie — vérifie toujours l'estimation avant de valider.", en: 'AI: Mistral only (no other provider). The plate photo scan can misidentify what it sees — always check the estimate before confirming.' },
